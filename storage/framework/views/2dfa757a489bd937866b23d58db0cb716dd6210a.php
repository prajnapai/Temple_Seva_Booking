                ...
                <div id="loadData">
                    <div class="col-xs-12 "style="margin:3% auto;">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 card-style" > 
                            <div class="card">
                                <div class="card-body">
                                    <h2><?php echo e($data['catcount']); ?></h2>
                                    <p>Category</p>
                                </div>
                            </div>
                        </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12  card-style"> 
                            <div class="card">
                                <div class="card-body">
                                <h2><?php echo e($data['sevacount']); ?></h2>
                                <p>Seva</p>
                                </div>
                            </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 card-style"> 
                            <div class="card">
                                <div class="card-body">
                                <h2><?php echo e($data['bookcount']); ?></h2>
                                <p>Bookings</p>
                                </div>
                            </div>
                    </div>
...
</html><?php /**PATH C:\Users\prajn\project\resources\views/back-end/dashboard.blade.php ENDPATH**/ ?>