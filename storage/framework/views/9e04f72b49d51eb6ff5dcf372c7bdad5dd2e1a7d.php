                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                              ...
                              <select class="form-control" id="sevacategory" name="sevacategory">
                                  ...
                                  <option value="<?php echo e($c->category_id); ?>"><?php echo e($c->cat_name); ?></option>
                ...
                <div class="col-xs-12 book-style" style="overflow-x:scroll">
                    ...
                    <table class="table table-responsive text-nowrap">
                        ...
                        <?php $__currentLoopData = $data['sevaloop']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="col-md-2"><?php echo e($p->seva_name); ?></td>
                                    <td class="col-md-2"><?php echo e($p->seva_category); ?></td>
                                    <td class="col-md-1"> <img src="<?php echo e($p->seva_img); ?>" alt="img" width="60"class="img-responsive"></td>
                                   
                                    <td class="col-md-2"><?php echo e($p->time); ?></td>
                                    <td ><?php echo e($p->duration); ?></td>
                                    <td class="col-md-1"><?php echo e($p->amount); ?></td>
                                    <td class="col-md-1"><?php echo e($p->description); ?></td>
                                    <td class="col-md-2">
                                        <button type="button" class="btn btn-default btnedit" id="edit" name="edit" onclick="editSeva(<?php echo e($p->seva_id); ?>)"><img src="back-end/img/pen.png" width="20"></button>
                                        <button type="button" class="btn btn-default btndel" id="delete" name="delete" onclick="deleteSeva(<?php echo e($p->seva_id); ?>)"><img src="back-end/img/delete.png" width="20"></button>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\Users\prajn\project\resources\views/back-end/seva_back.blade.php ENDPATH**/ ?>