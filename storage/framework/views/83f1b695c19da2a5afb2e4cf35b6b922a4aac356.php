        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 ">
                <nav id="sidebar" style="padding-bottom: 40vh;">
                    ...
                    <h3> Welcome <?php echo e($data['userdetail']->name); ?>!!</i></h3>
                    <hr>
                    </div>
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 ">
                    ...
                    <div class="col-xs-12 profile-style" >
                        ...
                        <form id="profileform">
                            ...
                            <input type="hidden" name="customer_id" id="customer_id" value="<?php echo e($data['profileloop']->id); ?>">
                            <input type="hidden" name="_token" id="token2" value="<?php echo e(csrf_token()); ?>">
                            
                            
                                <div class="form-group">
                                    <label for="firstname">Fist Name </label>
                                    <input type="text" id="firstname" name="firstname"  value="<?php echo e($data['profileloop']->firstname); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lastname" name="lastname"  value="<?php echo e($data['profileloop']->lastname); ?>" class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mobileno" name="mobileno"  value="<?php echo e($data['profileloop']->contact); ?>" class="form-control " >
                                </div>
                            </div>
...
<?php /**PATH C:\Users\prajn\project\resources\views/front-end/profile.blade.php ENDPATH**/ ?>