        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse " id="navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <?php } else { ?>
                <li>
                  <a href="profile" class="open-button"><i class="fa-solid fa-circle-user"></i> <?php echo e($data['userdetail']->name); ?></a>
                </li>
...
<?php /**PATH C:\Users\prajn\project\resources\views/front-end/layouts/header.blade.php ENDPATH**/ ?>